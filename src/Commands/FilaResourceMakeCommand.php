...
namespace Sorethea\Fila\Commands;

use Filament\Commands\MakeResourceCommand as Command;
use Illuminate\Support\Str;
use Sorethea\Fila\Supports\Stub;

class FilaResourceMakeCommand extends Command
{
    protected $signature = 'module:make-fila-resource {name?} {module?} {--soft-deletes} {--view} {--G|generate} {--S|simple} {--F|force}';

    protected $description = 'Generate filament resource for laravel modules.';

    protected function getDefaultStubPath(): string
    {
        $stub = new Stub("/filament");
        return $stub->getPath();
    }
